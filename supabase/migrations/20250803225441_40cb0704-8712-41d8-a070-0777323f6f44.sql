...
-- Create notification types for new features
INSERT INTO admin_settings (setting_key, setting_value, description, updated_by)
VALUES 
  ('notification_types', '["booking_request", "booking_accepted", "booking_declined", "cleaner_arrived", "access_required", "no_show_detected", "appeal_submitted"]', 'Available notification types for the system', (SELECT auth.uid()))
